...
public class LogicOrdenCompra {
    ...
    public String mantenimiento(OrdenCompra beanOrdenCompra) throws ClassNotFoundException, InstantiationException, IllegalAccessException, SQLException, Exception {
        ...
        Parametro param8 = new Parametro("IN", beanOrdenCompra.getProveedor().getId());
        Parametro param9 = new Parametro("IN", beanOrdenCompra.getMoneda().getN_idmon());
        Parametro param10 = new Parametro("IN", beanOrdenCompra.getAlmacen().getId());
        Parametro param11 = new Parametro("IN", beanOrdenCompra.getFormaPago().getId());
        Parametro param12 = new Parametro("IN", beanOrdenCompra.getTipoOperacion());
